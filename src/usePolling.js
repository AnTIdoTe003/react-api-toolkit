...
var usePolling = function (_a) {
    var url = _a.url, params = _a.params, token = _a.token, _b = _a.interval, interval = _b === void 0 ? 5000 : _b, onSuccess = _a.onSuccess, onError = _a.onError;
    ...
    useEffect(function () {
        var intervalId = setInterval(fetchData, interval);
